        ...
        <div className="bg-black text-white min-h-screen pt-32 pb-24">
            <div className="container mx-auto px-4 md:px-8 max-w-7xl">
                <div className="text-center mb-20 flex flex-col items-center">
                    <span className="text-secondary font-bold tracking-[0.3em] text-sm uppercase mb-4 block">Studio Insights</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    {posts.map((post, i) => (
                        <div key={i} className="group cursor-pointer">
                            <div className="h-[250px] bg-[#111] border border-white/5 mb-6 overflow-hidden relative">
                                ...
                                {/* Visual placeholder for thumbnails */}
                                ...
                                <div className="absolute top-4 left-4 bg-primary text-black font-bold uppercase tracking-widest text-xs px-3 py-1.5 z-20">
                                    {post.category}
                                </div>
                            </div>
                            <div className="flex items-center text-secondary text-sm font-bold uppercase tracking-widest mb-3">
                                <CalendarDays size={16} className="mr-2" /> {post.date}
                            </div>
                            <h3 className="text-2xl font-bold uppercase tracking-wide leading-tight mb-4 group-hover:text-primary transition-colors">
                                {post.title}
                            </h3>
                            <p className="text-gray-400 mb-6 line-clamp-2">
                                {post.desc}
                            </p>
                            <div className="flex items-center text-sm font-bold uppercase tracking-widest text-white group-hover:text-primary transition-colors">
                                Read Article <ArrowRight size={16} className="ml-2 transition-transform group-hover:translate-x-2" />
                            </div>
                        </div>
                    ))}
                </div>
